//
//  GetPopularTVShowsInteractorTest.swift
//  DomainTests
//
...
final class GetPopularTVShowsInteractorTest: XCTestCase {
    
    private let disposeBag = DisposeBag()
    private var sut: GetPopularTVShowsInteractor!
    private var repositoryStub: TVShowsRepositoryStub!
    
    override func setUp() {
        super.setUp()
        repositoryStub = TVShowsRepositoryStub()
        sut = GetPopularTVShowsInteractor(tvShowsRepository: repositoryStub)
    }

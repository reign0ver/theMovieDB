//
//  GetUpcomingMoviesInteractorTest.swift
//  DomainTests
//
...
final class GetUpcomingMoviesInteractorTest: XCTestCase {
    
    private let disposeBag = DisposeBag()
    private var sut: GetUpcomingMoviesInteractor!
    private var repositoryStub: MoviesRepositoryStub!
    
    override func setUp() {
        super.setUp()
        repositoryStub = MoviesRepositoryStub()
        sut = GetUpcomingMoviesInteractor(moviesRepository: repositoryStub)
    }
